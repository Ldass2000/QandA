                ...
                <div class="col-md-6">
                    <div class="myLeftCtn">
                        <form class="myForm text-center" action="login_register.php" method="POST" autocomplete="off">
                            <heade>Welcome</header>
                           

                            <div class="form-group">
                                <i class="fas fa-envelope"></i>
                                <input class="myInput" name="email_username" placeholder="Email or username" type="text" id="Email" required>
                            </div>
                            ...
                            <input type="submit" name="submit" class="butt" value="Login">
                ...
                <div class="col-md-6">
                    <div class="myRightCtn"> 
                        <div class="box">
                            ...
                            <p>Enter your details to continue with this amazing journey</p>
                            <input type="button" class="butt_out" value="Learn More" />
                        </div>
                     
                    </div>
                    <div class="link">Forgot password? <a href="signup.php">Signup here</div>
                </div>
